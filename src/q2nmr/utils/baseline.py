...
correcting spectral baselines. Copied with modifications from nmrglue. Mostly these are
from proc_bl.py  of the nmrglue package (https://github.com/jjhelmus/nmrglue). 
